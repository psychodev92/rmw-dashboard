    ...
    <div class="container mx-auto">
        <form action="{{ route('reviews.store') }}" method="POST" class="flex flex-col gap-3">
            ...
            <div class="flex items-center">
                ...
                <input type="text" id="title" name="title" class="rmw-toSlug flex-1 border rounded-md p-2 outline-none" required />
            </div>

            <div class="flex items-center">
                <label class="flex-1 max-w-[100px]" for="slug">Slug</label>
                <input type="text" id="slug" name="slug" class="rmw-slugInput flex-1 border rounded-md p-2 outline-none bg-gray-100 pointers-none" readonly />
            </div>
