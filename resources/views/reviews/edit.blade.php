                ...
                <div class="container mx-auto">
                    <form action="{{ route('reviews.update', ['review' => $singleReview->id]) }}" method="POST" class="flex flex-col gap-3">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="text" value={{ addslashes($singleReview->title) }} id="title" name="title" class="flex-1 border rounded-md p-2 outline-none" required />
                        </div>

                        <div class="flex items-center">
                            <label class="flex-1 max-w-[100px]" for="slug">Slug</label>
                            <input type="text" value={{ $singleReview->slug }} id="slug" name="slug" class="flex-1 border rounded-md p-2 outline-none bg-gray-100 pointers-none" readonly />
                        </div>
